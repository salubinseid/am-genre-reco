...
parent_dir = 'GenreDataset' # Training directory 
tr_sub_dirs = ["tizeta","ambasel","anchihoye","bati"]
...
#np.savetxt("ts_features.txt", ts_features)  # save array value to the text file
#np.savetxt("ts_labels.txt", ts_labels)
